...
import com.yunian.ai.feature.settings.ui.viewmodel.YandereModeViewModel
        ...
        Column(
                ...
                Card(
                    modifier = Modifier
                        ...
                        .drawGlass(
                            backdrop = LocalPageBackdrop.current,
                            shape = RoundedCornerShape(16.dp),
                            surfaceColor = permissionCardColor
                        ),
                    colors = CardDefaults.cardColors(containerColor = Color.Transparent),
                    shape = RoundedCornerShape(16.dp)
                ) {
                    Column(
                        ...
                        Row(
                            ...
                            Icon(
                                imageVector = if (hasPermission) AppIcons.CircleCheckBig else AppIcons.CircleAlert,
            ...
            OutlinedCard(
                ...
                Row(
                    ...
                    Icon(
                        imageVector = AppIcons.FlaskConical,
                        contentDescription = null,
